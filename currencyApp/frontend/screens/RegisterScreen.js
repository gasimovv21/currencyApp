...
const RegisterScreen = ({ route, navigation }) => {
  ...
  const handleRegister = async () => {
    ...
    if (!isOver18) {
      Alert.alert(
        "Please",
        "You must confirm that you are over 18 and accept View & Agreements for registering."
      );
      return;
    }
            ...
            <View style={styles.modalContent}>
              ...
              <ScrollView>
                <Text style={styles.modalText}>
                  ...
                  {"\n\n"}1. The currency exchange platform is provided as is,
                  without guarantees.
                  {"\n\n"}2. Users must comply with applicable laws for all
                  transactions.
                  {"\n\n"}3. The platform reserves the right to suspend accounts
                  in case of suspicious activity.
                  {"\n\n"}4. Rates are subject to fluctuations based on market
                  conditions.
                  {"\n\n"}5. Users are responsible for securing their account
                  credentials.
